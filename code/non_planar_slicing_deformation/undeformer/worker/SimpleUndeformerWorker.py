...
import numpy as np
from typing_extensions import cast, override, List
...
class SimpleUndeformerWorker(UndeformerWorker):
    ...
    def run(self) -> None:  # noqa: C901
        ...
        # read gcode
        gcodeCommands: List[GcodeLineType] = self._readGcode(state, self.gcode)
